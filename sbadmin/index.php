...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container">
        <br/>
        <img class="img-fluid mb-5 d-block mx-auto" src="img/sman 1 bojonegoro.png" alt="">
        <h1 class="text-uppercase mb-0">SMAN 1 BOJONEGORO</h1><br/><br/>
        <img src="img/siswa.jpg" alt="" class="img-thumbnail">
       ...
       <section class="portfolio" id="portfolio">
        ...
        <h2 class="text-center text-uppercase text-secondary mb-0">Pilihan Menu</h2><br/>
          ...
          <hr class="font-weight-light mb-0">Home</hr>
            <a class="portfolio-item d-block mx-auto" href="Home.php">
          ...
          <hr class="font-weight-light mb-0">Data Siswa</hr>
            <a class="portfolio-item d-block mx-auto" href="datasiswa.php">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                </div>
              </div>
          ...
          <hr class="font-weight-light mb-0">Transaksi</hr>
            <a class="portfolio-item d-block mx-auto" href="transaksi.php">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                </div>
              </div>
              <img class="img-fluid" src="img/transaksi.jpg" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <hr class="font-weight-light mb-0">Laporan</hr>
            <a class="portfolio-item d-block mx-auto" href="laporan.php">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                </div>
              </div>
              <img class="img-fluid" src="img/notepaper.jpg" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <hr class="font-weight-light mb-0">Reminder</hr>
            <a class="portfolio-item d-block mx-auto" href="reminder.php">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                </div>
              </div>
              <img class="img-fluid" src="img/alarm.png" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <hr class="font-weight-light mb-0">Form Pengisian</hr>
            <a class="portfolio-item d-block mx-auto" href="FormInput.php">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                </div>
              </div>
